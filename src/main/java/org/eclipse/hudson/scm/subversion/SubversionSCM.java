...
public class SubversionSCM extends SCM implements Serializable {
    ...
    public static class DescriptorImpl extends SCMDescriptor<SubversionSCM> implements hudson.model.ModelObject {
         ...
         */
        public static final class PasswordCredential extends org.eclipse.hudson.scm.subversion.credential.PasswordCredential {
         ...
         * @deprecated left for backward compatibility.
         */
        public static final class SshPublicKeyCredential extends
            org.eclipse.hudson.scm.subversion.credential.SshPublicKeyCredential {
        ...
        public static final class SslClientCertificateCredential
            extends org.eclipse.hudson.scm.subversion.credential.SslClientCertificateCredential {
        ...
        public void postCredential(final String url, final UserProvidedCredential upc, PrintWriter logWriter)
            ...
            try {
                ...
                UserProvidedCredential.AuthenticationManagerImpl authManager = upc.new AuthenticationManagerImpl(logWriter) {
                    @Override
    ...
    public static final class ModuleLocation implements Serializable {
        ...
        /**
         * Parses and populates list of {@link ModuleLocation} from string arrays.
         *
         * @param remoteLocations remoteLocations.
         * @param localLocations localLocations.
         * @param depthOptions depthOptions.
         * @param isIgnoreExternals isIgnoreExternals.
         * @return list of {@link ModuleLocation}.
         */
